...
function Home() {
    ...
    const handleAddCourse = async (newCourse)=>{
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addCourse"])(newCourse); // Call API
            setCourses((prev)=>[
                    ...prev,
                    response.data
                ]); // Update state
