...
"[project]/app/api/api.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/app/api/api.js [app-ssr] (ecmascript)");
...
const LoginPage = ({ setIsLoggedIn })=>{
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["login"])({
                email,
                password
            }); // Send login request
            const { token } = response.data;
            localStorage.setItem('token', token); // Save token in localStorage
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setAuthToken"])(token); // Set token for Axios
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__96df02._.js.map